...
void Snake::Update(std::mutex& latest_tick_mtx, std::condition_variable& last_tick_cv, const std::shared_ptr<Uint32> last_tick, const std::shared_ptr<UserInput> latest_input) {
...
void Snake::HandleInput(const UserInput input) {
